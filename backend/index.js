...
var mangoose = require("./config/mongodb");
const app = express();
...
app.use(cors({ origin: "http://3.13.209.241:3000", credentials: true }));
...
app.use((req, res, next) => {
  res.setHeader("Access-Control-Allow-Origin", "http://3.13.209.241:3000");
